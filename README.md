...
<h1 style="color: red;">To download a specific folder from this repository, simply go to that folder, copy the URL, paste here and press Enter https://download-directory.github.io/</h1>
