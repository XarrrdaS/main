...
```diff
# - To download a specific folder from this repository, simply go to that folder, copy the URL, paste here and press Enter - ![#f03c15](https://download-directory.github.io/)
```
<h1> 💫 About Me:</h1>
