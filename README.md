...
$\textcolor{red}{To\ download\ a\ specific\ folder\ from\ this\ repository,\ simply\ go\ to\ that\ folder,\ copy\ the\ URL,\ paste\ to\ the\ input\ box\ under\ the\ link\ and\ press\ enter }$
