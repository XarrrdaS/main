    ...
    <header>
        ...
        <?php
                    ...
                    $budzet = $row['budzet'];
                        ...
                        echo '<section id="cel" class="text-warning">
                        <div class="container">
                            <div class="row">
                    ...
                    <section id="opis" class="accordion-section clearfix mt-3 text-warning" aria-label="Question Accordions">
                        <div class="container">
                            <div class="row">
                                <div class="col text-left">
                    ...
                    <section id="informacje"  class="text-warning">
                        <div class="container">
                            <div class="row">
                                <div class="col text-left">
