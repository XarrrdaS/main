    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-light sticky-top">
        <div class="container color-text">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#cel">Cel Operacji
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#opis">Opis Operacji</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#informacje">Informacje</a>
                    </li>
