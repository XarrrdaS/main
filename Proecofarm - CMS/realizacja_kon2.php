    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-lights">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-warning sticky-top">
        <div class="container color-text">
            <a class="navbar-brand" href="index_kon2.php">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index_kon2.php#cel">Cel Operacji
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index_kon2.php#opis">Opis Operacji</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="index_kon2.php#galeria">Galeria</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index_kon2.php#informacje">Informacje</a>
                    </li>
