...
<link rel="stylesheet" href="CSS/bootstrap_kon.min.css">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-lights">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container color-text">
            <a class="navbar-brand" href="index_kon.php">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index_kon.php#cel">Cel Operacji
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index_kon.php#opis">Opis Operacji</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="realizacja.php">Realizacja projektu</a>
                            <a class="dropdown-item" href="index_kon.php#galeria">Galeria</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index_kon.php#informacje">Informacje</a>
                    </li>
    ...
    <?php
                    ...
                    $content_main2 = $row['content_main2'];
                        ...
                        echo '
                        <section id="cel" class="text-white">
                        <div class="container">
                            <div class="row">
    ...
    <footer class="page-footer font-small special-color-dark" class="text-white">
