                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="realizacja_kon.php">Realizacja projektu</a>
    ...
    <header>
        ...
        <?php
                    ...
                    $budzet = $row['budzet'];
                        ...
                        echo '<section id="cel" class="text-white">
                        <div class="container">
                            <div class="row">
                    ...
                    <section id="galeria" class="text-white">
                        <div class="container">
                            <div class="row">
                                <div class="col text-left">
                    ...
                    <section id="informacje" class="text-white">
                        <div class="container">
                            <div class="row">
                                <div class="col text-left">
